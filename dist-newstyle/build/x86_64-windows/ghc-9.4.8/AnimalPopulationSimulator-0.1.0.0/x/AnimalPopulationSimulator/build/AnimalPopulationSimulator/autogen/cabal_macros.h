...
/* package AnimalPopulationSimulator-0.1.0.0 */
#ifndef VERSION_AnimalPopulationSimulator
#define VERSION_AnimalPopulationSimulator "0.1.0.0"
#endif /* VERSION_AnimalPopulationSimulator */
#ifndef MIN_VERSION_AnimalPopulationSimulator
#define MIN_VERSION_AnimalPopulationSimulator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AnimalPopulationSimulator */
/* package AnimalPopulationSimulator-0.1.0.0 */
#ifndef VERSION_AnimalPopulationSimulator
#define VERSION_AnimalPopulationSimulator "0.1.0.0"
#endif /* VERSION_AnimalPopulationSimulator */
...
#define CURRENT_COMPONENT_ID "AnimalPopulationSimulator-0.1.0.0-inplace-AnimalPopulationSimulator"
